...
public interface MobileList extends MobileElement {
     ...
     * @param expected Expected entities in the form of objects extending {@link MobileElement} or xpath location in the form
     ...
     * for android, it will return only the count on elements in current view, not the whole list.
