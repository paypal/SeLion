...
/**
 * This test demonstrates how to add additional Selenium capabilities via WebTest annotation
 */
public class AdditionalSeleniumCapabilitiesViaWebTest {
  ...
  public void testCapabilityViaAnnotation() {
    ...
    assertEquals(Grid.getWebTestSession().getAdditionalCapabilities().getCapability("key"), "value");
  }
}