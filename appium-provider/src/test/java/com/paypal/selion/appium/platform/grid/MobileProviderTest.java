...
public class MobileProviderTest {
    ...
    @Test
    void testMobileDriverLoad() {
        MobileProviderService providerService = MobileProviderService.getInstance();
        assertNotNull(providerService);
        DefaultCapabilitiesBuilder appiumBuilder = providerService.capabilityBuilder(MobileNodeType.APPIUM);
        assertNotNull(appiumBuilder);
    }
